...
export default function SectionHeader({ label, title, description, align = "center", className }: SectionHeaderProps) {
  return (
    <div className={cn("mb-12", align === "center" && "text-center", className)}>
      ...
      {description && (
        <p className="mt-4 max-w-2xl text-[length:var(--font-size-section-body)] text-muted mx-auto break-keep">
          {description}
        </p>
      )}
    </div>
