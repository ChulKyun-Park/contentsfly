/**
 * 문의하기 폼 → Notion DB 저장
 * Notion DB: "문의하기" (collection://31ba5180-39db-8143-835a-000b83ac61d4)
 *
 * 스키마:
 *   소속기관명 (title), 담당자명 (rich_text), 담당자 메일주소 (email),
 *   담당자 연락처 (phone_number), 로컬리제이션 분야 (select),
 *   정기 작업 유무 (select), 상담 내용 (rich_text), 개인정보동의 (checkbox)
 */
